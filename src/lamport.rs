...
pub fn lamport_generate_keys(seed: &[u8; 16]) -> (Vec<[u8; 16]>, Vec<[u8; 16]>) {
...
pub fn lamport_sign_message(msg: &[u8], sk: &Vec<[u8; 16]>) -> Vec<[u8; 16]> {
    ...
    for i in 0..128 { 
        ...
        signature.push(sk[2*i+bit]); // add to signature
    }
...
pub fn lamport_verify_signature(msg: &[u8], signature: &Vec<[u8; 16]>, public_key: &Vec<[u8; 16]>) -> bool {
    ...
    for i in 0..128 {
        ...
        let preimage: [u8; 16] = signature[i];
